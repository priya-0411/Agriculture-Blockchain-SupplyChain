        ...
        <Route path="/" element={
          <>
            ...
            <section id="home" className="hero">
              <div className="hero-container">
                <div className="hero-text">
                  <h1>Transparent Agricultural Supply Chain using Technology</h1>
                  <p>
                ...
                <div className="hero-image">
                  <img src="https://images.unsplash.com/photo-1707286563398-7f97699cf29a" alt="Agriculture" />
                </div>
              </div>
            </section>
            ...
            <footer id="contact" className="footer">
              ...
              <p className="copyright">© {new Date().getFullYear()} AgriChain</p>
            </footer>
          </>
        } />
